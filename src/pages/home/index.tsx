  ...
  return (
    <View className="min-h-screen bg-canvas pb-6 text-ink">
      ...
      <View className="px-4 py-3">
        <View className="rounded-lg bg-brand-deep p-4 shadow-medium" onClick={() => router.to(routes.resourceHome)}>
          <Text className="rounded bg-white/10 px-2 py-1 text-xs font-semibold text-gold-light">供应链资源库</Text>
          <Text className="mt-3 block text-xl font-bold leading-7 text-white">70+ 优质资源，财税公司专属底价</Text>
        ...
        <View className="mt-3 rounded-lg bg-white p-4 shadow-soft">
          ...
          {[
            ...
            <View key={item.title} className="border-t border-line py-3" onClick={() => router.to(item.path)}>
