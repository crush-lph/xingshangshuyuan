...
export const routes = {
  ...
  courseLearn: '/pages/course/learn/index',
  coursePurchase: '/pages/course/purchase/index',
  ...
  opportunityApplications: '/pages/opportunity/applications/index',
  ...
  userCourses: '/pages/user/courses/index',
  userMessages: '/pages/user/messages/index',
